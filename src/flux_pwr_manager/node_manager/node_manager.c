...
void add_job(uint64_t jobId) { node_power_data->jobId = jobId; }
void remove_job(uint64_t jobId) { node_power_data->jobId = -1; }
void handle_job_cb(flux_t *h, flux_msg_handler_t *mh, const flux_msg_t *msg,
                   void *arg) {}
