...
#define BUFFER_SIZE 360  // Number of samples in seconds, total 6 mins collect data
int num_of_job = 0;
...
void flux_pwr_manager_get_hostname_cb (flux_t *h,
...
void flux_pwr_manager_set_powerlimit_cb (flux_t *h,
                                         flux_msg_handler_t *mh,
                                         const flux_msg_t *msg,
                                         void *arg)
{
    ...
    if (flux_request_unpack (msg, NULL, "{s:I}", "gl_pl", &global_powerlimit) < 0) {
...
void handle_jobtap_nodelist_rpc (flux_future_t *f, void *args)
{
    ...
    if (strcmp (topic, "job.state.run") == 0) {
        cluster_mgr_add_new_job (current_cluster_mgr,
                                 id,
                                 job_hostname_list,
                                 size,
                                 job_cwd,
...
void flux_pwr_manager_job_notification_rpc_cb (flux_t *h,
                                               flux_msg_handler_t *mh,
                                               const flux_msg_t *msg,
                                               void *args)
{
...
//
// }
void flux_pwr_manager_jobtap_destructor_cb (flux_t *h,
                                            flux_msg_handler_t *mh,
                                            const flux_msg_t *msg,
                                            void *args)
{
...
void flux_pwr_manager_disable_pm_cb (flux_t *h,
                                     flux_msg_handler_t *mh,
                                     const flux_msg_t *msg,
                                     void *args)
{
...
static const struct flux_msg_handler_spec htab[] = {
    {FLUX_MSGTYPE_REQUEST,
     "pwr_mgr.set_global_powerlimit",
     flux_pwr_manager_set_powerlimit_cb,
     0},
    ...
    {FLUX_MSGTYPE_REQUEST, "pwr_mgr.jm-get_pwr_node", node_manager_end_job_cb, 0},
    {FLUX_MSGTYPE_REQUEST,
     "pwr_mgr.cm-set_powerratio",
     cluster_mgr_set_power_ratio_cb,
     0},
    {FLUX_MSGTYPE_REQUEST,
     "pwr_mgr.cm-set_global_pl",
     cluster_mgr_set_global_powerlimit_cb,
     0},
    {FLUX_MSGTYPE_REQUEST, "pwr_mgr.get_hostname", flux_pwr_manager_get_hostname_cb, 0},
    {FLUX_MSGTYPE_REQUEST,
     "pwr_mgr.job_notify",
     flux_pwr_manager_job_notification_rpc_cb,
     0},
    {FLUX_MSGTYPE_REQUEST, "pwr_mgr.nm-disable_pm", node_manager_disable_pm_cb, 0},
    {FLUX_MSGTYPE_REQUEST, "pwr_mgr.disable_pm", flux_pwr_manager_disable_pm_cb, 0},
    {FLUX_MSGTYPE_REQUEST,
     "pwr_mgr.jobtap_destructor_notify",
     flux_pwr_manager_jobtap_destructor_cb,
     0},
...
int mod_main (flux_t *h, int argc, char **argv)
{
    ...
    flux_watcher_t *timer_watch_p =
        flux_timer_watcher_create (flux_get_reactor (h), 90.0, 90.0, timer_handler, h);
