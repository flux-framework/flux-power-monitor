...
{
    // Every time, get data into each job. This require calling cluster_mgr to collect
    // data from each job and in turn each job collect data for each node.
...
int mod_main (flux_t *h, int argc, char **argv)
{
    ...
    flux_watcher_t *timer_watch_p =
        flux_timer_watcher_create (flux_get_reactor (h), 10.0, 5.0, timer_handler, h);
